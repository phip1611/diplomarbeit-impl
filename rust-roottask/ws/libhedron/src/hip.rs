...
impl HIP {
    ...
    pub const fn cpu_offs(&self) -> u16 {
        self.cpu_offs
    }
    pub const fn cpu_size(&self) -> u16 {
        self.cpu_size
    }
    pub const fn ioapic_offs(&self) -> u16 {
        self.ioapic_offs
    }
    pub const fn ioapic_size(&self) -> u16 {
        self.ioapic_size
    }
    pub const fn mem_offs(&self) -> u16 {
        self.mem_offs
    }
    pub const fn mem_size(&self) -> u16 {
        self.mem_size
    }
    pub const fn api_flg(&self) -> HipFeatureFlags {
        self.api_flg
    }
    pub const fn api_ver(&self) -> u32 {
        self.api_ver
    }
    pub const fn sel_num(&self) -> u32 {
        self.sel_num
    }
    pub const fn num_exc_sel(&self) -> u32 {
        self.num_exc_sel
    }
    pub const fn num_vmi_sel(&self) -> u32 {
        self.num_vmi_sel
    }
    pub const fn num_gsi_sel(&self) -> u32 {
        self.num_gsi_sel
    }
    pub const fn cfg_page(&self) -> u32 {
        self.cfg_page
    }
    pub const fn cfg_utcb(&self) -> u32 {
        self.cfg_utcb
    }
    pub const fn freq_tsc(&self) -> u32 {
        self.freq_tsc
    }
    pub const fn freq_bus(&self) -> u32 {
        self.freq_bus
    }
    pub const fn pci_bus_start(&self) -> u32 {
        self.pci_bus_start
    }
    pub const fn mcfg_base(&self) -> u64 {
        self.mcfg_base
    }
    pub const fn msfg_size(&self) -> u64 {
        self.msfg_size
    }
    pub const fn dmar_tables(&self) -> u64 {
        self.dmar_tables
    }
    pub const fn hpet_base(&self) -> u64 {
        self.hpet_base
    }
    pub const fn cap_vmx_sec_exec(&self) -> u64 {
        self.cap_vmx_sec_exec
    }
    pub const fn xsdt_rdst_table(&self) -> u64 {
        self.xsdt_rdst_table
    }
    pub const fn pm1a_cnt(&self) -> &AcpiGas {
        &self.pm1a_cnt
    }
    pub const fn pm2b_cnt(&self) -> &AcpiGas {
        &self.pm2b_cnt
    }
    ...
    pub const fn root_pd(&self) -> CapSel {
        self.num_exc_sel as u64
    }
    /// Returns the cap selector for the root EC.
    /// See spec pdf 6.1.2.3 Object Space
    pub const fn root_ec(&self) -> CapSel {
...
impl HipCpu {
    ...
    pub const fn _reserved(&self) -> &[u8; 3] {
        &self._reserved
    }
...
impl HipMem {
    ...
    pub const fn typ(&self) -> HipMemType {
        self.typ
    }
    ...
    /*pub const fn mb_cmdline(&self) -> Option<&'a str> {
        unsafe {
