...
use libhedron::syscall::create_ec::{
    sys_create_global_ec,
    sys_create_local_ec,
};
use libhedron::syscall::create_pd::sys_create_pd;
use libhedron::syscall::create_pt::sys_create_pt;
use libhedron::syscall::create_sc::sys_create_sc;
use libhedron::syscall::pd_ctrl::{
    sys_pd_ctrl_delegate,
    DelegateFlags,
};
use libhedron::syscall::pt_ctrl::sys_pt_ctrl;
...
/// Like [`libhedron::syscall::create_pd::sys_create_pd`] but for usage in hybrid foreign applications.
...
/// Like [`libhedron::syscall::create_ec::sys_create_global_ec`] but for usage in hybrid foreign applications.
...
/// Like [`libhedron::syscall::create_ec::sys_create_local_ec`] but for usage in hybrid foreign applications.
...
/// Like [`libhedron::syscall::create_pt::sys_create_pt`] but for usage in hybrid foreign applications.
...
/// Like [`libhedron::syscall::pt_ctrl::sys_pt_ctrl`] but for usage in hybrid foreign applications.
...
/// Like [`libhedron::syscall::pt_ctrl::sys_pd_ctrl_delegate`] but for usage in hybrid foreign applications.
...
/// Like [`libhedron::syscall::pt_ctrl::sys_create_sc`] but for usage in hybrid foreign applications.
